...
namespace BuilderAssignment
{
    internal class Program
    {
        ...
        // TODO#3: Use your RamenChef to prepare (build) each type of ramen (Miso, Spicy, Vegan)
            RamenBowl miso = ramenChef.PrepareRamen(misoRamenBuilder);
            RamenBowl vegan = ramenChef.PrepareRamen(veganRamenBuilder);
            RamenBowl spicy = ramenChef.PrepareRamen(spicyRamenBuilder);
        ...
        //          the RamenBowl and print it out using WriteLine method 
            ...
            Console.WriteLine(RamenBowl.FinishedBowlOfRamen(miso));
            Console.WriteLine(RamenBowl.FinishedBowlOfRamen(spicy));
            Console.WriteLine(RamenBowl.FinishedBowlOfRamen(vegan));
        }
